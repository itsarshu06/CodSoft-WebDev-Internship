!(function (t, i, o, e) {
  ...
  (n.prototype = {
    init: function () {
      var i = this;
      t("html").hasClass("nivo-lightbox-notouch") ||
        t("html").addClass("nivo-lightbox-notouch"),
        "ontouchstart" in o && t("html").removeClass("nivo-lightbox-notouch"),
        ...
        this.options.keyboardNav &&
          t("body")
            ...
            .on("keyup", function (o) {
              ...
              27 == e && i.destructLightbox(),
                37 == e && t(".nivo-lightbox-prev").trigger("click"),
                39 == e && t(".nivo-lightbox-next").trigger("click");
            }),
              ...
              t(".nivo-lightbox-nav").show(),
                t(".nivo-lightbox-prev")
                  ...
                  .on("click", function (i) {
                    ...
                    (e = h.eq(n - 1)),
                      t(e).length || (e = h.last()),
                      t
                        .when(o.options.beforePrev.call(this, [e]))
                        .done(function () {
                          o.processContent(l, e),
                            o.options.onPrev.call(this, [e]);
                        });
                  }),
                t(".nivo-lightbox-next")
                  ...
                  .on("click", function (i) {
                    ...
                    var n = h.index(e);
                    (e = h.eq(n + 1)),
                      t(e).length || (e = h.first()),
                      t
                        .when(o.options.beforeNext.call(this, [e]))
                        .done(function () {
                          o.processContent(l, e),
                            o.options.onNext.call(this, [e]);
                        });
                  });
            }
            setTimeout(function () {
              a.addClass("nivo-lightbox-open"),
                o.options.afterShowLightbox.call(this, [a]);
            }, 1);
          }
        }
      }
    ...
    processContent: function (o, e) {
      ...
      if (
        ...
        this.isHidpi() &&
          e.attr("data-lightbox-hidpi") &&
          (a = e.attr("data-lightbox-hidpi")),
        null !== a.match(/\.(jpeg|jpg|gif|png)$/i))
      ) {
        ...
        h
          .one("load", function () {
            ...
            e.append(h),
              o.html(e).removeClass("nivo-lightbox-loading"),
              e.css({
        ...
        if (
          ("youtube" == l[1] &&
            ((s = "//www.youtube.com/embed/" + l[4]),
            (r = "nivo-lightbox-youtube")),
          "youtube-nocookie" == l[1] &&
            ((s = a), (r = "nivo-lightbox-youtube")),
          "youtu" == l[1] &&
            ((s = "//www.youtube.com/embed/" + l[3]),
            (r = "nivo-lightbox-youtube")),
          "vimeo" == l[1] &&
            ((s = "//player.vimeo.com/video/" + l[3]),
        ...
        t.ajax({
          ...
          success: function (e) {
            ...
            n.append(e),
              o.html(n).removeClass("nivo-lightbox-loading"),
              n.outerHeight() < o.height() &&
                n.css({
                  position: "relative",
                  top: "50%",
        ...
        "#" == a.substring(0, 1) &&
        "inline" == e.attr("data-lightbox-type")
      )
        if (t(a).length) {
          var g = t('<div class="nivo-lightbox-inline" />');
          g.append(t(a).clone().show()),
    ...
    constructLightbox: function () {
      ...
      var s = this;
      return (
        s.options.clickOverlayToClose &&
          i.on("click", function (i) {
            (i.target === this ||
              t(i.target).hasClass("nivo-lightbox-content") ||
              t(i.target).hasClass("nivo-lightbox-image")) &&
              s.destructLightbox();
          }),
        s.options.clickImgToClose &&
          i.on("click", function (i) {
            (i.target === this ||
              t(i.target).hasClass("nivo-lightbox-image-display")) &&
              s.destructLightbox();
          }),
    ...
    destructLightbox: function () {
      ...
      this.options.beforeHideLightbox.call(this),
        ...
        t("body").removeClass("nivo-lightbox-body-effect-" + i.options.effect);
      var o = /*@cc_on!@*/ 0;
      o &&
        (t(".nivo-lightbox-overlay iframe").attr("src", " "),
        t(".nivo-lightbox-overlay iframe").remove()),
        t(".nivo-lightbox-prev").off("click"),
        t(".nivo-lightbox-next").off("click"),
        t(".nivo-lightbox-content").empty(),
